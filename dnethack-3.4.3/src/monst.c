 ...
 */
	...
	A(ATTK(AT_TUCH, AD_PLYS, 2, 4), ATTK(AT_NONE, AD_PLYS, 1, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(600, 25, 0, MS_SILENT, MZ_LARGE),
	...
	LVL(20, 15, 10, 100, -5), (G_HELL|G_GENO|2),
...
//ifdef CHARON
    MON("Cerberus", S_DOG,//14 //encyclopedia exists
 ...
 */
	...
	LVL(15, 20, -2, 50, -6), (G_GENO|G_SGROUP|2),
...
*/    MON("hobbit", S_HUMANOID,//2
	...
	SIZ(2000, 500, 0, MS_GURGLE, MZ_LARGE), MR_COLD|MR_POISON|MR_SLEEP, MR_SLEEP,
	M1_SWIM|M1_AMPHIBIOUS|M1_HUMANOID|M1_OMNIVORE|M1_POIS,
 ...
 */
	...
	CLR_CYAN),
    MON("legion devil grunt", S_IMP,//10 //could use better quote
    ...
    MON("Glasya", S_IMP,//53 //needs quote
 ...
 */
	...
	M2_HOSTILE, M3_TENGTPORT, HI_LORD),
/*
 * trappers, lurkers, &c
 */
    MON("baby metroid", S_TRAPPER,//2 //Encyclopedia entry added
	...
	CLR_GREEN),
    MON("metroid", S_TRAPPER,//7 //Encyclopedia entry added
	...
	CLR_BRIGHT_GREEN),
    MON("alpha metroid", S_TRAPPER,//11 //Encyclopedia entry added
    ...
    MON("gamma metroid", S_TRAPPER,//16 //Encyclopedia entry added
	...
	M2_STALK|M2_HOSTILE|M2_NASTY|M2_NEUTER, M3_INFRAVISIBLE|M3_INFRAVISION,
	CLR_ORANGE),
    MON("zeta metroid", S_TRAPPER,//23 //Encyclopedia entry added
	...
	M2_STALK|M2_HOSTILE|M2_NASTY|M2_NEUTER, M3_INFRAVISIBLE|M3_INFRAVISION,
	CLR_YELLOW),
    MON("omega metroid", S_TRAPPER,//33 //Encyclopedia entry added
...
*/
	...
	A(ATTK(AT_BUTT, AD_DREN, 3,12), ATTK(AT_KICK, AD_FIRE, 1, 6),
...
*/
    MON("bebelith", S_XAN, //14? //Encyclopedia entry added
...
//	M3_INFRAVISIBLE|M3_INFRAVISION, CLR_BROWN),
	...
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_ARRW, AD_SOLR, 7, 1),
	  ATTK(AT_GAZE, AD_BLND, 2, 6), ATTK(AT_MAGC, AD_SPEL, 4, 6),
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_CUSS, MZ_LARGE),
	MR_FIRE|MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON, 0,
	M1_FLY|M1_HUMANOID|M1_SEE_INVIS|M1_REGEN,
	...
	SIZ(WT_HUMAN*70, 400, 0, MS_CUSS, MZ_HUGE),
	MR_FIRE|MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON, 0,
	M1_FLY|M1_HUMANOID|M1_SEE_INVIS|M1_REGEN,
 ...
 */
	 ...
	 */
    MON("baby gray dragon", S_DRAGON,//13
    ...
    MON("baby silver dragon", S_DRAGON,//13
	LVL(12, 9, 2, 10, 0), G_GENO,
	A(ATTK(AT_BITE, AD_PHYS, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1500, 500, 0, MS_ROAR, MZ_HUGE), 0, 0,
...
#endif
    MON("baby red dragon", S_DRAGON,//13
	LVL(12, 9, 2, 10, 0), G_GENO,
	A(ATTK(AT_BITE, AD_PHYS, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("baby white dragon", S_DRAGON,//13
	LVL(12, 9, 2, 10, 0), G_GENO,
	A(ATTK(AT_BITE, AD_PHYS, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("baby orange dragon", S_DRAGON,//13
	LVL(12, 9, 2, 10, 0), G_GENO,
	A(ATTK(AT_BITE, AD_PHYS, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("baby black dragon", S_DRAGON,//13
	LVL(12, 9, 2, 10, 0), G_GENO,
	A(ATTK(AT_BITE, AD_PHYS, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("baby blue dragon", S_DRAGON,//13
	LVL(12, 9, 2, 10, 0), G_GENO,
	A(ATTK(AT_BITE, AD_PHYS, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("baby green dragon", S_DRAGON,//13
	LVL(12, 9, 2, 10, 0), G_GENO,
	A(ATTK(AT_BITE, AD_PHYS, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("baby yellow dragon", S_DRAGON,//13
	LVL(12, 9, 2, 10, 0), G_GENO,
	A(ATTK(AT_BITE, AD_PHYS, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
    ...
    MON("lethe elemental", S_ELEMENTAL,//12?
	LVL(12, 24, -2, 66, -10), (G_NOCORPSE|G_HELL|0),
 ...
 */
	...
	A(ATTK(AT_NONE, AD_ACID, 0, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(50, 100, 0, MS_SILENT, MZ_SMALL), MR_ACID|MR_STONE, MR_STONE,
	...
	SIZ(100, 200, 0, MS_SHRIEK, MZ_SMALL), MR_POISON, MR_POISON,
	M1_BREATHLESS|M1_NOEYES|M1_NOLIMBS|M1_NOHEAD|M1_MINDLESS|M1_NOTAKE,
	...
	A(ATTK(AT_CLAW, AD_DRDX, 1, 3), NO_ATTK, NO_ATTK, 
		NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1000, 200, 0, MS_SHRIEK, MZ_HUMAN), MR_POISON|MR_ACID|MR_COLD, MR_POISON,
	...
	LVL(9, 10, -6, 40, 0), (G_GENO| G_LGROUP|2),
	A(ATTK(AT_GAZE, AD_MIST, 0, 0), ATTK(AT_WEAP, AD_ELEC, 2, 3), ATTK(AT_CLAW, AD_DRDX, 1, 3), 
		NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1300, 250, 0, MS_SHRIEK, MZ_HUMAN), MR_POISON|MR_ACID|MR_COLD|MR_ELEC, MR_POISON,
	...
	A(ATTK(AT_GAZE, AD_MIST, 0, 0), ATTK(AT_CLAW, AD_DRIN, 7, 3), 
	  ATTK(AT_MAGC, AD_SPEL, 3, 3), ATTK(AT_CLAW, AD_DRDX, 1, 3), 
		NO_ATTK, NO_ATTK),
	SIZ(1450, 400, 0, MS_SHRIEK, MZ_HUMAN), MR_POISON|MR_ACID|MR_COLD, MR_POISON,
	M1_BREATHLESS|M1_NOEYES|M1_NOHEAD|M1_SEE_INVIS|M1_POIS, 
	M2_NASTY|M2_NEUTER|M2_COLLECT|M2_JEWELS|M2_MAGIC, M3_INFRAVISION|M3_CHILL, CLR_GRAY),
	MON("migo queen", S_FUNGUS,//18
	LVL(12, 10, -6, 90, 0), (G_GENO|G_NOHELL|1),
	A(ATTK(AT_GAZE, AD_MIST, 0, 0), ATTK(AT_CLAW, AD_PLYS, 3, 3),
	  ATTK(AT_CLAW, AD_DRIN, 9, 3), ATTK(AT_MAGC, AD_CLRC, 3, 3), 
		NO_ATTK, NO_ATTK),
	SIZ(1900, 600, 0, MS_SHRIEK, MZ_HUMAN), MR_POISON|MR_ACID|MR_ELEC|MR_COLD, MR_POISON,
	M1_BREATHLESS|M1_NOEYES|M1_NOHEAD|M1_SEE_INVIS|M1_POIS, 
	M2_NASTY|M2_NEUTER|M2_COLLECT|M2_JEWELS|M2_MAGIC|M2_LORD, M3_INFRAVISION|M3_CHILL, CLR_WHITE),
    MON("phantom fungus", S_FUNGUS,//18
	LVL(15, 12, -15, 120, 0), (G_GENO|2), //needs quote
 ...
 */
	...
	A(ATTK(AT_MAGC, AD_CLRC, 3, 6),  ATTK(AT_BITE, AD_PHYS, 3, 2),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	A(ATTK(AT_BUTT, AD_PHYS, 2, 8), ATTK(AT_MAGC, AD_CLRC, 3,10),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1500, 700, 0, MS_SILENT, MZ_LARGE), 0, 0,
	M1_ANIMAL|M1_HUMANOID|M1_CARNIVORE,
	M2_HOSTILE|M2_STRONG|M2_NASTY|M2_GIANT, M3_INFRAVISIBLE|M3_INFRAVISION|M3_TRAITOR,
...
//#if 0	/* UN-DEFERRED */
	...
	LVL(25, 12, -2, 50, 0), (G_GENO|1), //Encyclopedia exists
	A(ATTK(AT_BITE, AD_VORP, 3, 10), ATTK(AT_BITE, AD_VORP, 3, 10),
	  ATTK(AT_CLAW, AD_VORP, 3, 10), ATTK(AT_CLAW, AD_PHYS, 3, 10),
	  NO_ATTK, NO_ATTK),
	SIZ(1300, 600, 0, MS_BURBLE, MZ_LARGE), 0, 0,
	M1_ANIMAL|M1_FLY|M1_CARNIVORE,
 ...
 * Keter Sephiroth
 */
    MON("Malkuth Sephirah", S_KETER,//3
	...
	M2_STALK|M2_NOPOLY|M2_HOSTILE|M2_STRONG|M2_NEUTER|M2_NASTY,
	M3_INFRAVISION, CLR_RED),//5
    MON("Hod Sephirah", S_KETER,
    ...
    MON("Gevurah Sephirah", S_KETER,//6
    ...
    MON("Chokhmah Sephirah", S_KETER,//6
	LVL(25, 12, 0, 25, 25), (G_NOCORPSE|G_NOGEN),
	A(ATTK(AT_WEAP, AD_CHKH, 2, 12),
	  ATTK(AT_WHIP, AD_MALK, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 200, 0, MS_ARREST, MZ_HUMAN), 0, 0, M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID|M1_THICK_HIDE,
	M2_STALK|M2_NOPOLY|M2_HOSTILE|M2_STRONG|M2_NEUTER|M2_NASTY|M2_ROCKTHROW,
	M3_INFRAVISION, HI_METAL),
/*
 * Liches
 */
    MON("lich", S_LICH,//14
    ...
    MON("death knight", S_LICH,//21  //Encyclopedia exists
 ...
 */
	...
	M1_BREATHLESS|M1_AMORPHOUS|M1_NOEYES|M1_NOLIMBS|M1_NOHEAD|
	  M1_MINDLESS|M1_OMNIVORE|M1_ACID|M1_POIS,
	M2_HOSTILE|M2_NEUTER, 0, CLR_GREEN),
    MON("darkness given hunger", S_PUDDING,//18
 ...
 */
    ...
    MON("uvuudaum", S_UMBER,//12 ency added
	LVL(19, 16, -6, 80, 0), (G_NOHELL|G_NOCORPSE|1),
	A(ATTK(AT_LRCH, AD_UVUU, 3, 12), ATTK(AT_CLAW, AD_PHYS, 3, 4),
	  ATTK(AT_CLAW, AD_PHYS, 3, 4), ATTK(AT_CLAW, AD_ABDC, 3, 4),
	  ATTK(AT_CLAW, AD_TELE, 3, 4), ATTK(AT_GAZE, AD_CONF, 0, 0)),
...
//	M3_INFRAVISIBLE, CLR_WHITE),
	...
	M3_WAITFORU|M3_INFRAVISIBLE, CLR_YELLOW),
    MON("Ilona Szilagy", S_VAMPIRE,//19
    ...
    MON("Carmilla", S_VAMPIRE,//19 //Encyc added
 ...
 */
	...
	LVL(12, 12, 4, 0, 0), (G_NOCORPSE|G_NOGEN),
 ...
 */
	...
	M3_WANTSAMUL|M3_INFRAVISIBLE, CLR_WHITE),
	...
	LVL(6, 10, 10, 0, -2), (G_SGROUP|G_NOGEN|G_GENO|1),//needs quote
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SOLDIER, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	...
	LVL(10, 10, 10, 15, -4), (G_NOGEN|G_GENO|1),//needs quote
	A(ATTK(AT_WEAP, AD_PHYS, 3, 4), ATTK(AT_WEAP, AD_PHYS, 3, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SOLDIER, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
...
MON("Daemon", S_HUMAN,//53 //Encyc entry added
	...
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8),
	  ...
	  ATTK(AT_MAGC, AD_SPEL, 0, 0), ATTK(AT_NONE, AD_FIRE, 9, 9)),
	SIZ(1200, 100, 0, MS_MUMBLE, MZ_HUMAN),
	MR_FIRE|MR_COLD|MR_SLEEP|MR_ELEC|MR_POISON, MR_FIRE|MR_COLD,
	M1_BREATHLESS|M1_HUMANOID|M1_POIS|M1_REGEN,
	M2_PRINCE|M2_HUMAN|M2_ORC|M2_ELF|M2_PNAME|M2_HOSTILE|M2_MALE, 
	M3_WANTSARTI|M3_INFRAVISION|M3_WAITFORU|M3_TRAITOR, HI_LORD),
/*
...
*/	MON("pit fiend", S_DEMON,//19
	...
	A(ATTK(AT_WEAP, AD_PHYS, 4, 2), ATTK(AT_CLAW, AD_PHYS, 4, 2),
	  ATTK(AT_BITE, AD_DRST, 3, 4), ATTK(AT_MAGC,AD_SPEL, 3, 8), 
	  NO_ATTK, NO_ATTK),
	 ...
	 */
	 MON("Firenna", S_DEMON,//34
	LVL(25, 20, 0, 94, 14), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),//quote needed
...
*/	//Munkir the white guardian Lion
	...
	MON("Bael", S_DEMON,//28
	LVL(40, 8, -9, 54, 18), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ), //quote needed
	...
	LVL(50, 3, -17, 65, -15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),//quote needed
	...
	LVL(56, 14, -5, 80, -15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),//quote needed
	...
	LVL(56, 18, -5, 80, -15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),//quote needed
	...
	LVL(60, 6, -3, 75, 15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ), //quote needed
...
*/	MON("Malcanthet", S_DEMON,//33
	LVL(63, 13, -7, 77, -19), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ), //quote needed
...
# define MLSEDUCTION_ATTACKS \
	...
	LVL(64, 10, 0, 44, 17), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ), //quote needed
	A( ATTK(AT_TUCH, AD_SSEX, 7, 2),
		ATTK(AT_WEAP, AD_PHYS, 7, 2), ATTK(AT_WEAP, AD_PHYS, 7, 2),
		ATTK(AT_MAGC, AD_CLRC, 10, 3), 
		NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 500, 0, MS_BRIBE, MZ_HUMAN), MR_FIRE|MR_POISON, 0,
	M1_SWIM|M1_SEE_INVIS|M1_POIS,
	M2_NOPOLY|M2_DEMON|M2_STRONG|M2_STALK|M2_HOSTILE|M2_PNAME|M2_NASTY|M2_LORD|
	...
	LVL(66, 18, -6, 66, -15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ), //quote needed
	A(ATTK(AT_CLAW, AD_SSEX, 1, 6), ATTK(AT_WEAP, AD_PHYS, 2, 8),
	  ATTK(AT_WEAP, AD_ACID, 3, 8), ATTK(AT_MAGC, AD_SPEL, 2, 6),
	  NO_ATTK, NO_ATTK),
	SIZ(900, 500, 0, MS_ORC, MZ_LARGE), MR_FIRE|MR_POISON, 0,
	M1_FLY|M1_SEE_INVIS|M1_POIS,
	...
	LVL(66, 9, -9, 99, -20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ), //quote needed
	...
	A(ATTK(AT_WEAP, AD_PHYS, 9, 1), ATTK(AT_WEAP, AD_PHYS, 9, 1), 
	  ...
	  ATTK(AT_MAGC, AD_SPEL, 8, 6), NO_ATTK),
	SIZ(1500, 500, 0, MS_BRIBE, MZ_HUGE), MR_FIRE|MR_POISON, 0,
	M1_FLY|M1_SEE_INVIS|M1_POIS,
...
*/	MON("Creature in the Ice", S_DEMON,//38
	...
	LVL(78, 15, -2, 80, 15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ), //quote needed
	A(ATTK(AT_WEAP, AD_PHYS, 9, 1), ATTK(AT_MAGC, AD_SPEL, 6, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(90, 8, -4, 100, 20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ), //quote needed
	...
	LVL(96, 10, -6, 96, -20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ), //quote needed
...
//	  ATTK(AT_TUCH, AD_DRLI, 3, 3), ATTK(AT_MAGC, AD_CLRC, 6, 6)),
	SIZ(1500, 500, sizeof(long)*1, MS_GROWL, MZ_HUGE), MR_FIRE|MR_POISON|MR_COLD|MR_DISINT|MR_SLEEP|MR_STONE, 0,
	M1_FLY|M1_SEE_INVIS|M1_POIS,
	...
	LVL(100, 13, -5, 100, -20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ), //quote needed
	...
	LVL(108, 18, -6, 95, -20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ), //quote needed
	A(ATTK(AT_CLAW, AD_DISE, 3, 12), ATTK(AT_CLAW, AD_DISE, 3, 12),//+shread armor or you
	  ...
	  ATTK(AT_MAGC, AD_SPEL, 6, 8), ATTK(AT_MAGC, AD_SPEL, 6, 8)),
	SIZ(1500, 500, sizeof(long)*2, MS_SHRIEK, MZ_HUGE), //int[0]: # of gazes that hit,
	MR_FIRE|MR_POISON|MR_ACID|MR_STONE, 0,				//int[1]: # of claws that hit
	M1_FLY|M1_SEE_INVIS|M1_NOHANDS|M1_POIS,
	M2_NOPOLY|M2_DEMON|M2_STALK|M2_HOSTILE|M2_PNAME|M2_NASTY|
 ...
 */
	...
	A(ATTK(AT_BITE, AD_PHYS, 4, 6), NO_ATTK,
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN*100, 40000, 0, MS_SILENT, MZ_GIGANTIC), 0, 0,
	M1_SWIM|M1_AMPHIBIOUS|M1_ANIMAL|M1_THICK_HIDE|M1_NOHANDS|
 ...
 */ MON("Tiamat", S_DRAGON,//17
	...
	A(ATTK(AT_WEAP, AD_ENCH, 4, 2), ATTK(AT_BITE, AD_DRST, 3, 4), //quote needed
	  ATTK(AT_MAGC,AD_SPEL, 3, 8), NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	A(ATTK(AT_WEAP, AD_PHYS, 4,6), ATTK(AT_ARRW, AD_BALL, 1, 9),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
   ...
   MON("alhoon", S_LICH,//21
	...
	LVL(100, 3, 0, 127, 0), (G_NOGEN|G_UNIQ), /*You might survive one melee hit from cthulhu, but prob not two*/
	A(ATTK(AT_CLAW, AD_PHYS, 1000, 1), ATTK(AT_GAZE, AD_WISD, 1, 10), //AD_IVST
	  ATTK(AT_NONE, AD_POSN, 8, 8), NO_ATTK,
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN*1000, 400*100, 0, MS_HISS, MZ_GIGANTIC), 
	...
	M2_NOPOLY|M2_NEUTER|M2_MAGIC|M2_GREEDY|M2_JEWELS|M2_COLLECT|M2_NASTY|M2_PNAME|M2_PRINCE,
	M3_INFRAVISIBLE|M3_INFRAVISION|M3_OPAQUE, HI_LORD),
	MON("Arsenal", S_GOLEM,// 21
	LVL(18, 6, 10, 127, 0), (G_NOCORPSE|G_NOGEN|G_UNIQ), //quote needed
	...
	LVL(19, 9, 0, 127, 0), (G_NOCORPSE|G_NOGEN|G_UNIQ), //quote needed
	...
	LVL(39, 19, -13, 99, 10), (G_NOCORPSE|G_NOGEN|G_UNIQ), //quote needed
