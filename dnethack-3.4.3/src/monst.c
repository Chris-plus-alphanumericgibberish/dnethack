...
# define MLSEDUCTION_ATTACKS \
	A( ATTK(AT_BITE, AD_SSEX, 0, 0), ATTK(AT_KICK, AD_PHYS, 8, 2), \
	  ATTK(AT_TUCH, AD_SLEE, 1, 3), ATTK(AT_SPIT, AD_DRST, 4, 2), \
	  NO_ATTK, NO_ATTK)
#else
# define MLSEDUCTION_ATTACKS \
	A(ATTK(AT_BITE, AD_DRLI, 9, 1), ATTK(AT_KICK, AD_PHYS, 9, 1), \
	  ATTK(AT_TUCH, AD_SLEE, 1, 9), ATTK(AT_SPIT, AD_DRST, 9, 1), \
	  NO_ATTK, NO_ATTK)
#endif
 ...
 */
   ...
   MON("alhoon", S_LICH,//21
	LVL(14, 9, -4, 90, 0), (G_NOGEN|G_NOCORPSE|0),
