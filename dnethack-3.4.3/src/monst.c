 ...
 */
	...
	LVL(6, 6, 8, 0, 0), (G_GENO|2),//needs quote
 ...
 */
	...
	LVL(22, 16, -6, 30, 0), (G_NOHELL|G_SGROUP|G_GENO|1), //needs quote
 ...
 */
	...
	LVL(8, 12, 3, 0, 0), (G_GENO|3), //needs quote
	A(ATTK(AT_CLAW, AD_PHYS, 4, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("lethe elemental", S_ELEMENTAL,//15
 ...
 */
	...
	LVL(3, 1, 7, 0, 0), (G_GENO|2),//needs quote
	...
	MON("migo philosopher", S_FUNGUS,//15
 ...
 */
    ...
    MON("chokhmah sephirah", S_KETER,//29
 ...
 */
    ...
    MON("Nazgul", S_WRAITH,//19 //Can't be permanently killed
	LVL(13, 14, 0, 45, -17), (1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8), 
 ...
 */
	...
	M3_INFRAVISIBLE, CLR_WHITE),
    MON("elder priest", S_HUMAN,//33 //Encyclopedia entry added
    ...
    MON("priest of an unknown god", S_DEMON,//26
...
*/	//Munkir the white guardian Lion
	...
	M3_WAITFORU|M3_WANTSAMUL|M3_INFRAVISIBLE|M3_INFRAVISION,
	HI_LORD),
    MON("Juiblex", S_DEMON,//28
	LVL(50, 3, -17, 65, -15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	M2_NOPOLY|M2_DEMON|M2_STRONG|M2_STALK|M2_HOSTILE|M2_PNAME|M2_NASTY|M2_LORD|
	  M2_MALE|M2_COLLECT,
	M3_WAITFORU|M3_WANTSAMUL|M3_INFRAVISIBLE|M3_INFRAVISION|M3_TRAITOR, HI_LORD),
	 MON("Daughter Lilith", S_DEMON,//33
	LVL(57, 12, 0, 94, 14), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ), //quote needed
...
# define MLSEDUCTION_ATTACKS \
	...
	LVL(63, 13, -7, 77, 20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ), //quote needed
	MLSEDUCTION_ATTACKS,
	...
	LVL(69, 7, -13, 93, 16), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ), //quote needed
	A(ATTK(AT_WEAP, AD_PHYS, 9, 1), ATTK(AT_WEAP, AD_PHYS, 9, 1), 
...
/*	MON("Lynkhab", S_DEMON,//49
	...
	M3_WAITFORU|M3_WANTSAMUL|M3_INFRAVISIBLE|M3_INFRAVISION|M3_TRAITOR,
	HI_LORD),
*/	MON("creature in the ice", S_DEMON,//38
	...
	LVL(74, 9, -9, 54, 15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ), //quote needed
...
//	  ATTK(AT_TUCH, AD_DRLI, 3, 3), ATTK(AT_MAGC, AD_CLRC, 6, 6)),
	...
	LVL(98, 8, -8, 108, 20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ), //quote needed
	...
	LVL(7, 12, 4, 30, 0), (G_NOGEN|G_NOCORPSE), //quote needed
	A(ATTK(AT_WEAP, AD_PHYS, 2, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	 ...
	 */
    MON("Chromatic Dragon", S_DRAGON,//23
 ...
 */ MON("Tiamat", S_DRAGON,//17
	...
	A(ATTK(AT_BREA, AD_RBRE, 6, 6), ATTK(AT_BITE, AD_PHYS, 3, 8),
	  ATTK(AT_MAGC, AD_SPEL, 0, 0), NO_ATTK,
	  NO_ATTK, NO_ATTK),
	SIZ(WT_DRAGON, 1500, 0, MS_ROAR, MZ_GIGANTIC), MR_POISON, MR_POISON,
	...
	LVL(6, 16, 10, 6, -3), G_UNIQ|G_NOCORPSE|G_NOGEN, //quote needed
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
   ...
   MON("alhoon", S_LICH,//21
	...
	LVL(19, 9, 0, 127, 20), (G_NOCORPSE|G_NOGEN|G_UNIQ), //quote needed
