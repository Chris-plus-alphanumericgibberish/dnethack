 ...
 */
	...
	A(ATTK(AT_GAZE, AD_DRLI, 0, 0), ATTK(AT_CLAW, AD_DREN, 2, 4),
	  ATTK(AT_CLAW, AD_DRLI, 2, 4), ATTK(AT_TUCH, AD_DRLI, 2, 3),
	  NO_ATTK, NO_ATTK),
...
*/	MON("Malcanthet", S_DEMON,//33
	...
	A( ATTK(AT_BITE, AD_SSEX, 0, 0), ATTK(AT_CLAW, AD_PHYS, 1, 4), 
	  ...
	  ATTK(AT_BITE, AD_DRLI, 1, 4), ATTK(AT_CLAW, AD_DREN, 2, 3)),
 ...
 */
   ...
   MON("alhoon", S_LICH,//21
	...
	LVL(100, 12, 0, 127, 0), (G_NOGEN|G_UNIQ), /*You might survive one melee hit from cthulhu, but prob not two*/
	A(ATTK(AT_CLAW, AD_PHYS, 400, 1), ATTK(AT_GAZE, AD_WISD, 1, 10), //AD_IVST
