...
PROJECTILE("elven arrow", "runed arrow",
		0, 20, 1, 2, 7, 6, 2, WOOD, -P_BOW, HI_WOOD),
PROJECTILE("orcish arrow", "crude arrow",
		0, 20, 1, 2, 5, 6, -1, IRON, -P_BOW, CLR_BLACK),
...
WEAPON("elven spear", "runed spear",
	0, 1, 0, 10, 30,  3,  7,  8, 2, P,   P_SPEAR, WOOD, HI_WOOD),
WEAPON("orcish spear", "crude spear",
	0, 1, 0, 13, 30,  3,  5,  8, -1, P,   P_SPEAR, IRON, CLR_BLACK),
...
WEAPON("orcish dagger", "crude dagger",
	0, 1, 0, 12, 10,  5,  3,  3, 1, P,   P_DAGGER, IRON, CLR_BLACK),
...
WEAPON("elven short sword", "runed short sword",
	0, 0, 0,  2, 30, 10,  8,  8, 2, P,   P_SHORT_SWORD, WOOD, HI_WOOD),
...
ARMOR("plate mail", (char *)0,
	1, 0, 1, 0,	44, 5, 450, 600,  0, 3, ARM_SUIT, IRON, HI_METAL),
ARMOR("crystal plate mail", (char *)0,
	1, 0, 1, 0,	10, 5, 900, 2000,  -6, 2, ARM_SUIT, GLASS, CLR_CYAN), /*Best armor, AC wise*/
#ifdef TOURIST
ARMOR("bronze plate mail", (char *)0,
	1, 0, 1, 0,	20, 5, 450, 400,  3, 3, ARM_SUIT, COPPER, HI_COPPER),
#else
ARMOR("bronze plate mail", (char *)0,
	1, 0, 1, 0,	35, 5, 450, 400,  3, 3, ARM_SUIT, COPPER, HI_COPPER),
#endif
