...
{	{"Anachrononaut", 0}, {
	...
	ART_ANNULUS,
	MA_HUMAN|MA_ELF|MA_VAMPIRE, ROLE_MALE|ROLE_FEMALE |
...
{	{"Binder", 		 0}, {
	...
	ART_PEN_OF_THE_VOID,
	MA_HUMAN|MA_DWARF|MA_GNOME|MA_ELF|MA_ORC|MA_CLOCK|MA_VAMPIRE|MA_DRAGON, ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_CHAOTIC|ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{  6,  6,  6,  6,  6,  6 },
	{ 11,  9,  9, 11, 11,  9 },
	/* Init   Lower  Higher */
	{ 11, 0,  0,  6,  0, 2 },	/* Hit points */
...
{	{"Caveman", "Cavewoman"}, {
	...
	MA_HUMAN|MA_DWARF|MA_GNOME|MA_DRAGON, ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{  10,  7,  7,  7,  8,  6 },
	{  30,  6,  7, 20, 30,  7 },
	/* Init   Lower  Higher */
	{ 14, 0,  0, 4,  0, 2 },	/* Hit points */
	{  1, 0,  0, 1,  0, 1 },10,	/* Energy */
...
{	{"Convict", 0}, {
	...
	MA_HUMAN|MA_DWARF|MA_GNOME|MA_ORC|MA_ELF|MA_VAMPIRE|MA_DRAGON, ROLE_MALE|ROLE_FEMALE |
	  ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{  10,  7,  7,  7, 13,  6 },
	{  20, 20, 10, 20, 20, 10 },
...
{	{"Healer", 0}, {
	...
	MA_HUMAN|MA_GNOME, ROLE_MALE|ROLE_FEMALE | ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{   7,  7, 13,  7, 11, 16 },
	{  15, 20, 20, 15, 25, 5 },
	/* Init   Lower  Higher */
...
{	{"Monk", 0}, {
	...
	MA_HUMAN|MA_CLOCK|MA_DRAGON, ROLE_MALE|ROLE_FEMALE |
...
{	{"Pirate", 0}, {
	...
	{  22, 15, 10, 22, 20, 10 },
	/* Init   Lower  Higher */
	{ 20, 0,  0, 3,  0, 2 },	/* Hit points (10 +d8 for 11 levels comes up a bit over 20 +d6 for 11 levels) */
...
{	{"Rogue", 0}, {
	...
	MA_HUMAN|MA_ORC|MA_VAMPIRE|MA_ELF|MA_DRAGON, ROLE_MALE|ROLE_FEMALE |
	  ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{   7,  7,  7, 10,  7,  6 },
	{  20, 10, 10, 30, 20, 10 },
	/* Init   Lower  Higher */
	{ 10, 0,  0, 2,  1, 0 },	/* Hit points */
...
{	{"Ranger", 0}, {
	...
	MA_HUMAN|MA_ELF|MA_GNOME|MA_ORC|MA_DRAGON, ROLE_MALE|ROLE_FEMALE |
	  ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{  13, 13, 13,  9, 13,  7 },
	{  30, 10, 10, 20, 20, 10 },
	/* Init   Lower  Higher */
	{ 13, 0,  0, 3,  1, 0 },	/* Hit points */
	{  1, 0,  0, 1,  0, 1 },12,	/* Energy */
...
{	{"Samurai", 0}, {
	...
	MA_HUMAN|MA_CLOCK|MA_DRAGON, ROLE_MALE|ROLE_FEMALE | ROLE_LAWFUL,
	/* Str Int Wis Dex Con Cha */
	{  10,  8,  7, 10, 17,  6 },
	{  30, 10,  8, 30, 14,  8 },
	/* Init   Lower  Higher */
	{ 13, 0,  0, 4,  1, 0 },	/* Hit points */
	{  1, 0,  0, 1,  0, 1 },11,	/* Energy */
...
{	{"Troubadour", 0}, {
	...
	ART_LYRE_OF_ORPHEUS,
	MA_HUMAN|MA_ELF|MA_GNOME|MA_ORC|MA_CLOCK|MA_DRAGON, ROLE_MALE|ROLE_FEMALE |
	  ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{   7,  7,  7, 10,  6, 10 },
	{  10, 10, 15, 25, 10, 30 },
...
{	{"Valkyrie", 0}, {
	...
	ART_ORB_OF_FATE,
	MA_HUMAN|MA_DWARF, ROLE_FEMALE | ROLE_LAWFUL|ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{  12,  10, 12, 10, 10, 12 },
	{  18,  14, 16, 18, 20, 14 },
	/* Init   Lower  Higher */
...
const int Langels[] = {PM_JUSTICE_ARCHON,PM_ANGEL,PM_SWORD_ARCHON,PM_SHIELD_ARCHON,PM_TRUMPET_ARCHON,PM_WARDEN_ARCHON,PM_THRONE_ARCHON,PM_LIGHT_ARCHON,NON_PM};
...
const int Nangels[] = {PM_MOVANIC_DEVA,PM_MONADIC_DEVA,PM_ASTRAL_DEVA,PM_ANGEL,PM_MAHADEVA,NON_PM};
const int NElemen[] = {PM_AIR_ELEMENTAL,PM_WATER_ELEMENTAL,PM_FIRE_ELEMENTAL,PM_EARTH_ELEMENTAL,NON_PM};
const int Cangels[] = {PM_BRALANI,PM_FIRRE,PM_SHIERE,PM_ANGEL,PM_GHAELE,PM_TULANI,NON_PM};
...
const int NBrigit[] = {PM_FIRRE,PM_FIRE_ELEMENTAL,PM_FIRE_VORTEX,PM_LIGHT_ARCHON,NON_PM};
...
const int CHuanTi[] = {PM_SOLDIER,PM_TERRACOTTA_SOLDIER,PM_TULANI,PM_LIGHT_ARCHON,NON_PM};

const int NSea[] = {PM_NOVIERE,PM_WATER_DEMON,PM_WATER_ELEMENTAL,PM_ICE_PARAELEMENTAL,PM_LIGHTNING_PARAELEMENTAL,PM_MORTAI,NON_PM};
...
const int LVarda[] = {PM_WHITE_UNICORN,PM_AIR_ELEMENTAL,PM_ANGEL,PM_LIGHT_ARCHON,NON_PM};
...
const int CSophia[] = {PM_ANGEL,PM_THRONE_ARCHON,PM_LIGHT_ARCHON,NON_PM};
