...
const int CPoseidon[] = {PM_NOVIERE_ELADRIN,PM_WATER_DEMON,PM_WATER_ELEMENTAL,PM_ICE_PARAELEMENTAL,PM_LIGHTNING_PARAELEMENTAL,PM_TITAN,NON_PM};
...
const int NSea[] = {PM_NOVIERE_ELADRIN,PM_WATER_DEMON,PM_WATER_ELEMENTAL,PM_ICE_PARAELEMENTAL,PM_LIGHTNING_PARAELEMENTAL,PM_MORTAI,NON_PM};
