...
STATIC_OVL char *SaberHilts[] = {
	...
	"This %s's hilt is a single long spiral.",
	"This %s's emitter disk is set into the jaws of a white tiger.",
	"This %s's emitter disk is held by the coils of a green dragon.",
	"A red bird holds this %s's emitter disk in it's beak, its wings form a saber guard.",
	"This %s has a black tortoise shell grip, and it's blade emerges from the beak of a black turtle head.",
