...
#define MS_ANIMAL	13	/* up to here are animal noises */ //is 13 correct???
...
#define MR_DRAIN	0x100	/* resists petrification */
#define MR_ALL		(MR_STONE|MR_ACID|MR_POISON|MR_ELEC|MR_DISINT|MR_SLEEP|MR_COLD|MR_FIRE)
